...
class GlobalLocationUpdated extends GlobalState {}

class GlobalAutoNavigateState extends GlobalState {}

class InactivityTimerUpdateState extends GlobalState {
  final int remainingSeconds;
  InactivityTimerUpdateState({required this.remainingSeconds});
}
